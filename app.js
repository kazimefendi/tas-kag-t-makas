...
select.addEventListener("click", (e) => {
  ...
  if (e.target.getAttribute("alt")) {
    ...
    yourChoice.innerHTML = `<img src="./img/${userSelect}.png"></img>`;
    pc();
  }
});
...
tasImage.addEventListener('click',(e)=>{
    console.log(e)
    yourChoice.innerHTML = `<img src="./img/tas.png"></img>`
})

kagitImage.addEventListener('click',(e)=>{
    console.log(e)
    yourChoice.innerHTML = `<img src="./img/kagit.png"></img>`;
})

makasImage.addEventListener('click',(e)=>{
    console.log(e)
    yourChoice.innerHTML = `<img src="./img/makas.png"></img>`;
}) */
